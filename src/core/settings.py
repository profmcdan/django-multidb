...
SECRET_KEY = 'django-insecure-*t&d_c)swql#e4+(r9mqsk_ny5h_=y2rnv0nu*3m-%v!e5-w7^'
...
DATABASE_ROUTERS = [
    'core.routers.db_routers.UserRouter',
    'core.routers.db_routers.StudentRouter',
    'core.routers.db_routers.TeacherRouter'
]
